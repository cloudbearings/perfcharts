...
public class JmeterAverageRTChartTemplate extends BaseChart2DTemplateWithInterval {
	...
	public Chart2DConfig generateChartConfig() {
		...
		Chart2DSeriesConfigRule rule = new Chart2DSeriesConfigRule("^TX-(.+)-S$", "Average Response Time", "ms",
				getLabelField(), xField, rtField, new AverageCalculation(
						getInterval()));
		
		rule.setExclusionRule(new Chart2DSeriesExclusionRule("$1", "ping.html"));
		rules.add(rule);
